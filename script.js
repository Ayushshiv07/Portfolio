/* ── TERMINAL LOADER ── */
        ...
        (function() {
            ...
            if (typeof THREE === 'undefined') {
                console.warn("Three.js library is not loaded. Skipping 3D animation.");
                return;
            }
            ...
            try {
                ...
                renderer.setClearColor(0x03060f, 0.0); // CRITICAL: Forces completely transparent canvas background
                ...
                for (let i = 0; i < packetsCount; i++) {
                    // Find a node with connections (with safe loop limit)
                    let startNodeIndex = Math.floor(Math.random() * nodesCount);
                    let attempts = 0;
                    while (nodes[startNodeIndex].connections.length === 0 && attempts < 100) {
                ...
                console.error("Three.js execution failed:", err);
            }
        })();